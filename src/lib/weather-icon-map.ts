...
export function getWeatherIconName(id: number, isDay: boolean = true) {
    return (providerIconMap as any)[isDay ? "openweathermap/codes/day" : "openweathermap/codes/night"][id.toString()] as string;
}